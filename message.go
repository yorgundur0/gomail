...
func obfuscateMessageContent(content string) string {
	...
	generateRandomElement := func() string {
	...
	// Iterate over each line and add random elements
	for i, line := range lines {
		// Add a random element at the beginning and end of each line
		lines[i] = generateRandomElement() + line + generateRandomElement()
	}
